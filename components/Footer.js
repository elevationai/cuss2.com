    ...
    <footer>
      <div class="wrap">
        <div class="footer-grid">
          ...
          <div class="footer-col">
            <h5>Solutions</h5>
            <a href="/solutions/elevated-tagging">Elevated Tagging</a>
            <a href="/solutions/bridge2to1">Bridge2to1</a>
            <a href="/solutions/c2-platform">C2-Platform</a>
            <a href="/solutions/platform-monitor">Platform-Monitor</a>
          </div>
          <div class="footer-col">
            <h5>Company</h5>
